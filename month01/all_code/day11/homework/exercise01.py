...
print_single_commodity(tld) # 传递Commodity类对象
# print_single_commodity("屠龙刀")# 传递str类对象[报错]

value  = commodity_max_by_price()
#<__main__.Commodity object at 0x7fc190d9a630>
print(value) # 直接打印自定义对象
print(value.__dict__)

descending_order_by_price()
# 列表没有__dict__
# print(list_commodity_infos.__dict__)
