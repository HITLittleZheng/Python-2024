...
INSERT INTO `books` VALUES (2,'骆驼祥子','老舍','机械工业出版社',46,'2018-10-01','你是祥子么？'),(3,'茶馆','老舍','中国文学出版社',58,'2018-10-01','老北京'),(4,'呐喊','鲁迅','人民教育出版社',53,'2019-10-01','最后的声音'),(5,'朝花夕拾','鲁迅','中国文学出版社',58,'2020-01-01','好时光'),(6,'围城','钱钟书','中国文学出版社',44,'2020-01-01','你心中的围城是什么'),(7,'林家铺子','茅盾','机械工业出版社',56,'2019-10-01',NULL),(8,'子夜','茅盾','人民教育出版社',52,'2019-10-01',NULL);
...
CREATE TABLE `mylike` (
  ...
  CONSTRAINT `mylike_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `mylike_ibfk_2` FOREIGN KEY (`friends_id`) REFERENCES `friends` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-07 15:40:18
